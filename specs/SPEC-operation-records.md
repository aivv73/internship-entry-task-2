...
must allocate increasing IDs while preserving transactionality. This record does not define submit,
provider dispatch, receipt handling, or final-state transitions.
